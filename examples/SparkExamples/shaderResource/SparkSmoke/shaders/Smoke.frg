...
// Based on  - https://www.shadertoy.com/view/MdyGzR  - Created by ehj1 in 2016-01-16
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    vec4    px = texture(iChannel0, v_uv);
    vec4 smoke = vec4(vec3(cloudIntensity1*clouds(uv))*lightColor1 + lighIntensity1*lightColor1 +
