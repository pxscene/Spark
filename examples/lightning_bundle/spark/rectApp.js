...
class MyApp extends ux$1.App {
    static _template() {
        return {
            ...
            RoundRectangle: {
                zIndex: 2,
                texture: lightning$1.Tools.getRoundRect(1280, 720, 360, 3, 0xffff00ff, true, 0xff00ffff),
                RoundRectangleChild: {
                  zIndex: 2,
                  x:200,
                  y:200,
                  texture: lightning$1.Tools.getRoundRect(720, 480, 260, 3, 0x00ffffff, true, 0x00ffffff),
                },
            }
        }
     }
    _handleUp(){
        this.tag("RoundRectangleChild").alpha = 0;
    }
    _handleDown(){
        this.tag("RoundRectangleChild").alpha = 1;
    }
}
