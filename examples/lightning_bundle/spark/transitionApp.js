...
class MyApp extends ux$1.App {
    static _template() {
        return {     
            LilLightning:{
                x: 250, y: 250, w: 100, h: 200, pivotX: 1, pivotY: 1, src: 'file:///Users/mthiru270/bundle/dist/spark/ll_image.png',
...
class MyApp extends ux$1.App {
    static _template() {
        return {
            FinishLine:{ w: 5, h: 600, colorTop: 0xFFABABAB, colorBottom: 0xFFFFFFFF, rect: true, x: 500, y: 200 },
            LilLightningA:{ x: 50, y: 100, src: MyApp.getPath("ll_image.png"), scaleX:2, scaleY:2},
            LilLightningB:{ x: 50, y: 300, src: MyApp.getPath("ll_image.png"), scaleX:2, scaleY:2},
            LilLightningC:{ x: 50, y: 500, src: MyApp.getPath("ll_image.png"), scaleX:2, scaleY:2}
        }
    }
