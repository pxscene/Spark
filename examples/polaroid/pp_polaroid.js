...
var imageHandler = (function() {
  ...
  return {
      ...
      getImageInfo:  function() {
        ...
        info.url = (pics != undefined && pics == 'flickr')? urls[urlIndex].url : basePackageUri + urls[urlIndex].url;
...
captionFont.ready.then( null, 
  function(res) {
    ...
    captionFont = scene.create({t:"fontResource", url:"http://sparkui.org/examples/fonts/IndieFlower.ttf"});}).
