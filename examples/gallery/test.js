...
px.import("px:scene.1.js").then(function (scene) {
 ...
 if (scene.capabilities.graphics.gif==undefined || scene.capabilities.graphics.gif==0)
  ...
  var url = "http://www.sparkui.org/examples/gallery/images/gifs/IMG_7.gif";
  var txt1 = scene.create({t:"textBox",w:200,h:100,textColor:0xff8800ff,text:url,parent:scene.root,pixelSize:15,y:600});
