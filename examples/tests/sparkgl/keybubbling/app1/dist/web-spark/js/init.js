function startApp() {
    ...
    if (!lng.Utils.isSpark) {
        ...
        sparkscene.root.on('onPreKeyDown', function(e) {
            console.log('in app1 webgl onPreKeyDown keyCode:', e.keyCode);
        });

        sparkscene.root.on('onKeyDown', function(e) {
            console.log('in app1 webgl onKeyDown keyCode:', e.keyCode);
