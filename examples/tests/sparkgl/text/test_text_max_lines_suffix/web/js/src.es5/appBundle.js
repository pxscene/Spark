...
var appBundle = function () {
  ...
  var max_lines_suffix = [false, // attribute will not be set
  ...
  for (var i in max_lines_suffix) {
    ...
    template['Text_' + i] = Defaults.applyToText(tpl, ['fontFace', 'fontSize', 'textColor', 'wordWrapWidth', 'maxLines']);
