...
var appBundle = function () {
  ...
  var font_styles = [false, // attribute will not be set
  'normal', 'italic', 'bold', 'italic bold', 'oblique 45deg'];
  ...
  for (var i in font_styles) {
    ...
    template['Text_' + i] = Defaults.applyToText(tpl, ['fontFace', 'fontSize', 'textColor']);
