...
scene.root.on("onChar", function(e) {
  ...
  if (e.charCode == 119) { // w for wordWrap
    ...
    if(textStatus.text == "text=multilines") {
      ...
      text2.text = newlineLongerText; 
      textStatus.text="text=newlinesLonger";
    } else if(textStatus.text == "text=newlinesLonger"){
      text2.text = newlineLongestText; 
      textStatus.text="text=newlinesLongest";
    } else if(textStatus.text == "text=newlinesLongest"){
      text2.text = longText; 
      ...
      textStatus.text="text=wordBoundaryCharsText";
    }
    else if(textStatus.text == "text=wordBoundaryCharsText"){
  ...
  } else if(e.charCode == 98) { // b for parent toggle
    if(text2.parent == root) {
      cleanup(); 
      parentStatus.text="parent=container";
     } else {
      setParentToRoot();
