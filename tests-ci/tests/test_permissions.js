...
.then(imports => {
  ...
  const this_url = px.getPackageBaseFilePath() + '/test_permissions.js?manualTest=0';
  ...
  module.exports.tests = {
    ...
    byDefaultArbitraryAppCanAccessGoogle: () => {
      return new Promise(resolve => {
        let appLink = "https://tinyurl.com/y8v5dd3o?module=https&url=https://www.google.com/"; 
        // -> https://www.sparkui.org/tests-ci/tests/helpers/test_access_url.js?module=https&url=https://www.google.com/
        let new_scene = scene.create({
    ...
    byDefaultArbitraryAppCanNotAccessLocalhost: () => {
      return new Promise(resolve => {
        let appLink = "https://tinyurl.com/y7ubzhug?module=https&url=https://127.0.0.1/"; 
        // -> https://www.sparkui.org/tests-ci/tests/helpers/test_access_url.js?module=https&url=https://127.0.0.1/
        let new_scene = scene.create({
          t: 'scene', parent: scene.root, w: scene.w, h: scene.h, url: appLink
        });
        new_scene.ready.then(s => {
