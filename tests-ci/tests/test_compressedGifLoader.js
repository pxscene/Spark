...
module.exports.beforeStart = function() {
  console.log("test_compressedGifLoader beforeStart()!");
...
var tests = {
// Testing compressedGifLoader with local file paths like /Users/../ or file:/Users/../
  ...
  return new Promise(function(resolve, reject) {
   ...
   var url = basePackageUri + "/images/compressedGif_1.gif";
    ...
    imageARes.ready.then(function()  {
      console.log("test_imageAResource_sourceType: imageARes ready");
        ...
        results.push(assert(loadStatus["sourceType"]==sourceType,"load type is not correct"));
  ...
  if (!isGifLoaderEnabled)
	...
	{
    return new Promise(function(resolve, reject) {
      var url = basePackageUri + "/images/compressedGif_2.gif";
...
if(manualTest === true) {
  ...
  console.log("err: "+err);
  console.error("Import for test_compressedGifLoader.js failed: " + err)
});
