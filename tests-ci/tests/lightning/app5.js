...
class Ui extends lightning$1.Application {
    ...
    static _template() {
        return {
            Mediaplayer: {type: lightning$1.Utils.isWeb ? Mediaplayer : NoopMediaplayer, textureMode: Ui.hasOption('texture')},
            AppWrapper: {}
        };
    }
...
class DevLauncher {
    ...
    _getLightningOptions(customOptions = {}) {
        ...
        if (ux.Ui.hasOption("720") || (lightning$1.Utils.isWeb && window.innerHeight === 720)) {
            config['w'] = 1280;
            config['h'] = 720;
...
class MyApp extends ux.App {
    static _template() {
        return {
            ...
            RectangleDefault: {
                x: 400, y: 400, w: 200, h: 100, rect: true, color: 0x00ff00ff
            },
            RoundRectangle: {
                x: 100,
                y: 100,
                zIndex: 2,
                texture: lightning$1.Tools.getRoundRect(150, 40, 4, 3, 0xffff00ff, true, 0xff00ffff),
            },
            Shadow: {
                x: 200,
                y: 200,
                zIndex: 1,
                color: 0x66000000,
                texture: lightning$1.Tools.getShadowRect(150, 40, 4, 10, 15)
            }
        };
    }
}
