...
var tests = {
  ...
  return new Promise(function(resolve, reject) {
    var imageRes = scene.create({t:"imageResource",parent:root, url:"https://sparkui.org/tests-ci/tests/images/dolphin.jpg"});
    var results = []; 
  ...
  test2: function() {
    return new Promise(function(resolve, reject) {
      var imageA = scene.create({t:"imageA",parent:root, url:"https://sparkui.org/tests-ci/tests/images/dolphin.jpg"});
      var results = [];
