...
var basePackageUri = px.getPackageBaseFilePath();
    ...
    var urls = [
      ...
      basePackageUri+"/images/001.jpg", // Lego Movie
      basePackageUri+"/images/002.jpg", // Kung Fu Panda
      basePackageUri+"/images/003.jpg", // Cabin Fever
      basePackageUri+"/images/008.jpg", // Inside Out
    ];
...
var noParent = scene.create({t:'image', url:basePackageUri+"/images/004.jpg"});
