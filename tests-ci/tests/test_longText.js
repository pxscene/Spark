...
manual:"../test-run/tools_manualTests.js"}).then( function ready(imports) {
  ...
  var test = [];
  var fonts = [
                "https://www.sparkui.org/examples/fonts/DejaVuSerif.ttf",
              ];
    ...
    test_text: function() {
      ...
      return new Promise(function(resolve, reject) {
        ...
        txt_obj.font.ready.then(function(){
          ...
          results.push(assert((metrics1.w == 2880000), 'text width does not match expected value. actual: '+metrics1.w+'; expected: 2880000'));          
        },function(){
