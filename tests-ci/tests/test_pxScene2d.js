...
var tests = {
  ...
  return new Promise(function(resolve, reject) {
        ...
        url = "https://sparkui.org/tests-ci/tests/images/ball.png"; 
  ...
  test4: function() {
    return new Promise(function(resolve, reject) {
    var image9 = scene.create({t:"image9",parent:root, url:"https://sparkui.org/tests-ci/tests/images/dolphin.jpg"});
    image9.ready.then(function()  {
      console.log("test4: image9 ready");
      var results = [];
      results.push(assert(image9.url=="https://sparkui.org/tests-ci/tests/images/dolphin.jpg","url is not proper"));
      resolve(results);
    }, function(obj) { 
      console.log("test4: REJECTION!");
      var results = [];
      results.push(assert(false,"https://sparkui.org/tests-ci/tests/images/dolphin.jpg failed to load!"));
      resolve(results);
    });
  });
  },
...
*/
  ...
  test10: function() {
    return new Promise(function(resolve, reject) {
        ...
        var results = [];
        var url = "https://sparkui.org/tests-ci/tests/images/ball.png"; 
