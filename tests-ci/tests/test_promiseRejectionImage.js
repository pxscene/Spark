...
var image = scene.create({t:"image",parent:root, x:0,y:100, url:"https://sparkui.org/notthere.png"});

var image2 = scene.create({t:"image",parent:root, x:0,y:100, url:"https://sparkui.org/tests-ci/tests/images/ball.png"});
