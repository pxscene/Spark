...
module.exports.tests.test13_dot_bracket_notation = () => {
  ...
  storage.key1 = 'value1';
  storage['key2'] = 'value2';
  const value1 = storage['key1'];
  const value2 = storage.key2;
  const valueNotExisting1 = storage.keyNotExisting1;
  const valueNotExisting2 = storage['keyNotExisting2'];

  return Promise.resolve(imports.assert(
    value1 === 'value1' && value2 === 'value2' && valueNotExisting1 === noValue && valueNotExisting2 === noValue,
